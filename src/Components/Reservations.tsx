  ...
  return (
    <div id='reservations' className="form-control my-10 md:w-4/6 m-auto">
      ...
      <form className='flex flex-col bg-alt w-fit m-auto' onSubmit={handleSubmit}>
        ...
        <button aria-label='Make reservation' type='submit' className='py-3 px-5 my-6 border border-neutral hover:border-secondary mx-auto bg-base-100 w-fit hover:text-secondary transition-colors duration-150 ease-linear'>Make reservation</button>
      </form>
    </div>
  )
}
