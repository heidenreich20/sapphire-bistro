...
const AboutUs = () => {
  return (
    <div className='bg-base-100 my-12 w-4/6 m-auto rounded-lg'>
      <ul className="flex w-full font-body justify-between gap-10">
        <li className="bg-neutral-900/[0.7] h-[350px] py-4 px-10 border-b twin-shadow border-b-secondary overflow-hidden text-ellipsis w-1/3">
